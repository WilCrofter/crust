...
* [Illustrating use of pixelated thigh utilities](www/illustrate_pix_thigh_utils.html)
* [Sharing data between R and Matlab (or Octave)](www/usingRMatlab.html)
* [Pixelated images of whole thigh section](www/thigh_large_pixelation.html)
* [Expanded test suite using 60 mm probe](www/revised_test_suite_thigh.html)
* [Basis for the system matrix row space](www/Splus_as_basis.html)
* [Test suite](www/test_suite_thigh.html)
* [Stripe space and dimension reduction](www/stripes_and_dim_reduction.html)
* [Some notes on projection and regularization](www/projection_regularization.html)
* [(Easy) projection on the orthogonal complement of the stripe space](www/proj_on_perp_of_stripes.html)
