...
In R, pixel columns correspond to the y dimension, equivalently to the rows of the matrix which contains the image. Hence the row sums of `orthogimg` will be equal.
