---
title: "Null space of S and other algebraic characteristics"
author: "W. Bauer"
date: "June 19, 2015"
output: html_document
---

### Some structure in the null space of S

A system matrix will have a null space of dimension at least n-1, where n is the number of columns of pixels in the associated image. Two such columns are shown in bright yellow in the figure below. Two transmitter-to-receiver paths are also shown. Each path intersects the columns in segments of equal length--4.4 mm for the path from 2 to 8, 4.8 mm for the path from 3 to 2. Of course, it's a matter of elementary geometry that any line crossing columns of equal width will intersect those columns in segments of the equal length. 
...
addPath(3,2,col="green3",lwd=3, setup = setup)
text(xvals[6]+15/7, xvals[4], "4.8 mm", col="green3", cex=1.24, srt = 30)
text(xvals[3]+15/7, xvals[2]+15/7, "4.8 mm", col="green3", cex=1.24, srt = 30)
addPath(2,8, col="magenta2", lwd=3, setup=setup)
text(xvals[6]+15/7, xvals[6]+1, "4.4 mm", col="magenta2", cex=1.24, srt = -10)
text(xvals[3]+15/7, xvals[7]-1, "4.4 mm", col="magenta2", cex=1.24, srt = -10)
```
